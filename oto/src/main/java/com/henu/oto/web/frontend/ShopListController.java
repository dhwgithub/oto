package com.henu.oto.web.frontend;
...
import com.henu.oto.service.ShopCategoryService;
...
public class ShopListController {
    ...
    private Map<String, Object> listShops(HttpServletRequest request){
        ...
        if (pageIndex > -1 && pageSize > -1){
            ...
            // 获取组合后的查询条件
            Shop shopCondition = compactShopCondition45Search(parentId, shopCategoryId, areaId, shopName);
     ...
     * @return
     */
    private Shop compactShopCondition45Search(long parentId, long shopCategoryId, int areaId, String shopName) {
